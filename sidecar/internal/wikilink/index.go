...
type Index struct {
	...
	// forwardLinks maps source file to its outgoing wikilinks.
...
// Remove deletes all index entries for a file.
...
// AllTargets returns all unique normalized target names.
